...
CREATE TABLE "new_SentEmail" (
    ...
    "checkoutLineItems" TEXT NOT NULL DEFAULT '',
    "checkoutCurrency" TEXT NOT NULL DEFAULT '',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "SentEmail_brandId_fkey" FOREIGN KEY ("brandId") REFERENCES "Brand" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_SentEmail" ("brandId", "clicked", "clickedAt", "convertedRevenue", "createdAt", "customerEmail", "customerName", "flowPosition", "flowType", "id", "orderId", "resendEmailId", "scheduledAt", "sentAt", "status") SELECT "brandId", "clicked", "clickedAt", "convertedRevenue", "createdAt", "customerEmail", "customerName", "flowPosition", "flowType", "id", "orderId", "resendEmailId", "scheduledAt", "sentAt", "status" FROM "SentEmail";
